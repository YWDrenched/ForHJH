...
extension SDNavBar {
    ...
    @objc func handleLeftOneButtonTapped(sender: UIButton) {
        letfOneButtonClosure?()
    }
    
    @objc func handleLeftTwoButtonTapped(sender: UIButton) {
        letfTwoButtonClosure?()
    }
    
    @objc func handleRightOneButtonTapped(sender: UIButton) {
        rightOneButtonClosure?()
    }
    
    @objc func handleRightTwoButtonTapped(sender: UIButton) {
